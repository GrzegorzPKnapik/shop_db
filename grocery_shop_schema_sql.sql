...
CREATE TABLE IF NOT EXISTS `grocery_shop`.`SHOPPING_LISTS` (
  ...
  PRIMARY KEY (`id`, `USERS_id`),
  INDEX `fk_SHOPPING_LIST_USERS1_idx` (`USERS_id` ASC) VISIBLE,
  INDEX `fk_SHOPPING_LISTS_ADDRESSES1_idx` (`ADDRESSES_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `grocery_shop`.`ORDERS` (
  ...
  INDEX `fk_ORDERS_SHOPPING_LISTS1_idx` (`SHOPPING_LISTS_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `grocery_shop`.`DESCRIPTIONS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `grocery_shop`.`DESCRIPTIONS` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `grocery_shop`.`PRODUCTS` (
  ...
  PRIMARY KEY (`id`, `IMAGES_id`, `PRODUCERS_id`, `CATEGORIES_id`, `DESCRIPTIONS_id`),
  INDEX `fk_PRODUCTS_IMAGES1_idx` (`IMAGES_id` ASC) VISIBLE,
  INDEX `fk_PRODUCTS_PRODUCERS1_idx` (`PRODUCERS_id` ASC) VISIBLE,
  INDEX `fk_PRODUCTS_CATEGORIES1_idx` (`CATEGORIES_id` ASC) VISIBLE,
  INDEX `fk_PRODUCTS_DESCRIPTIONS1_idx` (`DESCRIPTIONS_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_PRODUCTS_CATEGORIES1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_PRODUCTS_DESCRIPTIONS1`
    FOREIGN KEY (`DESCRIPTIONS_id`)
    REFERENCES `grocery_shop`.`DESCRIPTIONS` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `grocery_shop`.`SHOPPING_LISTS_PRODUCTS` (
  ...
  `SHOPPING_LISTS_id` INT NOT NULL,
  INDEX `fk_SHOPPING_LIST_has_PRODUCTS_PRODUCTS1_idx` (`PRODUCTS_id` ASC) VISIBLE,
  INDEX `fk_SHOPPING_LISTS_PRODUCTS_SHOPPING_LISTS1_idx` (`SHOPPING_LISTS_id` ASC) VISIBLE,
